      ...
      <div className='mx-5 max-w-5xl md:mx-auto my-10 mt-6'>
          ...
          <div className='flex flex-col gap-4'>
            {comments.map((item, index) => (
              <div key={index} className='relative bg-primary/2 border border-primary/5 max-w-xl p-4 rounded text-gray-600'>
                ...
                <div className='absolute bottom-3 right-4 text-xs flex items-center gap-2'>{moment(item.createdAt).fromNow()}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className='my-24 max-w-3xl mx-auto'>
            ...
            <div className='flex gap-2'>
              ...
              <FaTwitter className='text-3xl text-blue-600 cursor-pointer' />
              <FaGooglePlusG className='text-3xl text-blue-600 cursor-pointer' />
            </div>
        </div>
      </div>
