...
import { MdComment, MdDashboard, MdDrafts } from "react-icons/md";
  ...
  return (
    <div className='flex-1 p-4 md:p-10 bg-blue-50/50'>
      <div className='flex flex-wrap gap-4'>
        <div className='flex items-center gap-4 bg-white p-4 min-w-58 rounded shadow cursor-pointer hover:scale-105 translate-all duration-300'>
          <div className='w-16 h-16 flex items-center justify-center rounded bg-primary/5'>
            <MdDashboard className='text-3xl text-primary/70' />
          </div>
          <div>
        ...
        <div className='flex items-center gap-4 bg-white p-4 min-w-58 rounded shadow cursor-pointer hover:scale-105 translate-all duration-300'>
          <div className='w-16 h-16 flex items-center justify-center rounded bg-primary/5'>
            <MdComment className='text-3xl text-primary/70' />
          </div>
          <div>
        ...
        <div className='flex items-center gap-4 bg-white p-4 min-w-58 rounded shadow cursor-pointer hover:scale-105 translate-all duration-300'>
          <div className='w-16 h-16 flex items-center justify-center rounded bg-primary/5'>
            <MdDrafts className='text-3xl text-primary/70' />
          </div>
          <div>
        ...
        <div>
          <div className='flex items-center gap-3 m-4 mt-6 text-gray-600'>
            <VscNewFile className='text-3xl text-primary/90' />
            <p>Latest Blogs</p>
          </div>
